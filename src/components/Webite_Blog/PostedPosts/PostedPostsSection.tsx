          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 mt-1">
                Manage your published blog posts • {filteredPosts.length} of {posts.length} posts
              </p>
            </div>
          </div>
      ...
      {filteredPosts.length > 0 ? (
        ...
        <Card className="border-0 shadow-xl bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg rounded-2xl overflow-hidden">
          <CardContent className="text-center py-16 px-8">
            ...
            <h3 className="text-xl font-semibold mb-3 text-slate-900 dark:text-white">No Posts Found</h3>
            <p className="text-slate-600 dark:text-slate-400 mb-6 max-w-md mx-auto leading-relaxed">
              {posts.length === 0
                ? "You haven't created any posts yet. Start by creating your first blog post!"
